...
#define    HYN_RESET_PIN  1   /* IWG34M: Reset: Defining touch reset gpio number for GPIO1_1 */ 
...
static unsigned int  g_irq_pin = 8; /* IWG34M: Interrupt: Defining interrupt gpio number for GPIO1_8 */
...
{
#ifndef CONFIG_IWG34M
	/* IWG34M: Touch Software Reset not used */
	unsigned char buf[4];	
	buf[0] = 0xD1;	
	buf[1] = 0x0E;	 	
